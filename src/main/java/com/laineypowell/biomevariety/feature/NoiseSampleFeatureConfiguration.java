...
public record NoiseSampleFeatureConfiguration(Surface surface, BlockPredicate predicate, float radius, float resolution, float grain, float threshold) implements FeatureConfiguration {
